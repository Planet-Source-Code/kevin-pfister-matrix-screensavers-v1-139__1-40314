...
The agent is just an example picture for use to show the background imaging. Browse for it from the Configarations form
...
But before compiling to be run as a screensaver change it back
